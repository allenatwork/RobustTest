...
public class PhotoUtils {
    ...
    public static final int UPLOAD_WIDTH = 400;
    public static final int UPLOAD_HEIGHT = 600;
    ...
    public static Bitmap resizeBitmap(String pathFile) {
    ...
    public static Bitmap getResizedBitmap(Bitmap bm, int newWidth) {
        float aspectRatio  = ((float) newWidth) / bm.getWidth();
        int newHeight = Math.round(bm.getHeight() * aspectRatio);
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options) {
        ...
        Log.d("File resize", "W " + width + " H " + height);
        int sampleWidth = width / 400;
        int sampleHeight = height / 600;
        int min = sampleHeight >= sampleWidth ? sampleWidth : sampleHeight;
        return (int) Math.pow(2, ((int) (Math.sqrt(min))));
//        else return sampleWidth;
    }
